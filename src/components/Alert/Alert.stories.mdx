...
<Canvas>
  <Story
    ...
    args={{
      children:
        'Your list has been partially imported from MyAnimeList. The following items failed to import...',
    }}>
    {(args) => <Alert {...args} kind="warning" />}
  </Story>
</Canvas>
