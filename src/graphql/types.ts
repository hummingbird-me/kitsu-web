...
export type Anime = Episodic &
  ...
  WithTimestamps & {
    ...
    readonly relationships: MediaRelationshipConnection;
...
export type AnimeRelationshipsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type Comment = Holdable &
  WithTimestamps & {
    ...
    readonly createdAt: Scalars['ISO8601DateTime']['output'];
    /** The reason why this comment is held for manual moderator approval. */
    readonly heldReason?: Maybe<HeldReasonEnum>;
    readonly id: Scalars['ID']['output'];
...
/** The reason a record is held for manual moderator approval. */
export enum HeldReasonEnum {
  /** Caught by a spam filter. */
  Spamfilter = 'SPAMFILTER',
  /** Caught by a word filter. */
  Wordfilter = 'WORDFILTER',
}

/** User-generated content which can be held for moderation */
export type Holdable = {
  /** The reason this content was held for moderation */
  readonly heldReason?: Maybe<HeldReasonEnum>;
};
...
export type LibraryAllArgs = {
  ...
  sort?: InputMaybe<ReadonlyArray<InputMaybe<LibraryEntrySortOption>>>;
...
export type LibraryEntrySortOption = {
  readonly direction: SortDirection;
  readonly on: LibraryEntrySortEnum;
};
...
export type MangaRelationshipsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** A media in the Kitsu database */
export type MediaRelationshipsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type MediaReaction = Holdable &
  WithTimestamps & {
    ...
    /** The reason why this reaction is held for manual moderator approval. */
    readonly heldReason?: Maybe<HeldReasonEnum>;
    readonly id: Scalars['ID']['output'];
...
export type MediaRelationship = WithTimestamps & {
  readonly __typename?: 'MediaRelationship';
  readonly createdAt: Scalars['ISO8601DateTime']['output'];
  /** The destination media */
  readonly destination: Media;
  /** The kind of relationship */
  readonly kind: MediaRelationshipKindEnum;
  /** The source media */
...
export type MediaRelationshipConnection = {
  readonly __typename?: 'MediaRelationshipConnection';
  /** A list of edges. */
  readonly edges?: Maybe<ReadonlyArray<Maybe<MediaRelationshipEdge>>>;
  /** A list of nodes. */
  readonly nodes?: Maybe<ReadonlyArray<Maybe<MediaRelationship>>>;
  /** Information to aid in pagination. */
  readonly pageInfo: PageInfo;
  /** The total amount of nodes. */
  readonly totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type MediaRelationshipEdge = {
  readonly __typename?: 'MediaRelationshipEdge';
  /** A cursor for use in pagination. */
  readonly cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  readonly node?: Maybe<MediaRelationship>;
};
...
export type Post = Holdable &
  WithTimestamps & {
    ...
    /** The reason why this post is held for manual moderator approval. */
    readonly heldReason?: Maybe<HeldReasonEnum>;
    readonly id: Scalars['ID']['output'];
...
export type PostDeleteErrorsUnion =
  | NotAuthenticatedError
  | NotAuthorizedError
  | NotFoundError;
...
export type PostDeleteInput = {
  /** The id of the post. */
  readonly postId: Scalars['ID']['input'];
};

/** Autogenerated return type of PostDelete. */
export type PostDeletePayload = {
  readonly __typename?: 'PostDeletePayload';
  readonly errors?: Maybe<ReadonlyArray<PostDeleteErrorsUnion>>;
  readonly result?: Maybe<Post>;
};
...
export type PostMutations = {
  ...
  /** Delete a Post. */
  readonly delete?: Maybe<PostDeletePayload>;
  /** Lock a Post. */
