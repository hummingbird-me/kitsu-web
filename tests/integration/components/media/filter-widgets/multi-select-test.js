...
moduleForComponent('media/filter-widgets/multi-select', 'Integration | Component | media/filter widgets/multi select', {
  integration: true
});
...
test('selection is added to selected on click', function(assert) {
  ...
  this.render(hbs`{{#media/filter-widgets/multi-select
    selection=selection
    selected=selected
