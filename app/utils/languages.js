export default [
  ...
  // { id: 'ro-ro', text: 'Română' }, // Romanian [5/2]
  ...
  // { id: 'tr-tr', text: 'Türkçe' }, // Turkish [2/0]
  // { id: 'uk-ua', text: 'Українська' }, // Ukrainian [13/12]
